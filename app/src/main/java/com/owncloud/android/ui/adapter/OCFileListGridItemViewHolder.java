...
class OCFileListGridItemViewHolder extends RecyclerView.ViewHolder implements ListGridItemViewHolder {
    protected GridItemBinding binding;

    OCFileListGridItemViewHolder(GridItemBinding binding) {
